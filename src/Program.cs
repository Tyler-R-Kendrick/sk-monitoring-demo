...
public sealed class Program
{
    ...
    public static async Task Main()
    {
        ...
        using var loggerFactory = LoggerFactory.Create(builder =>
        {
            ...
            builder.AddOpenTelemetry(options =>
            {
                ...
                // If environment is set to development, log to console.
        ...
        {
            await RunOpenAIChatAsync(kernel);
            Console.WriteLine();
        ...
        {
            await RunOpenAIToolCallsAsync(kernel);
            Console.WriteLine();
        }
    }
    ...
    private const string OpenAIServiceKey = "OpenAI";
    ...
    private static async Task RunOpenAIChatAsync(Kernel kernel)
    {
        Console.WriteLine("============= OpenAI Chat Completion =============");

        using var activity = s_activitySource.StartActivity(OpenAIServiceKey);
    ...
    #region tool calls
    private static async Task RunOpenAIToolCallsAsync(Kernel kernel)
    {
